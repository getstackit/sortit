---
name: sortit-memory
description: Create, inspect, or review Sortit memories. Use when a coding, review, planning, or debugging session produces durable knowledge: decisions, lessons, constraints, patterns, references, or "future agents should know" context.
version: {{VERSION}}
---
