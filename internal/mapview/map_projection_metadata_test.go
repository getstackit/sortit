...
func TestOverlayProjectionIssueMetadataRefreshesMutableFields(t *testing.T) {
	...
	updated := issueviews.OverlayProjectionIssueMetadata(projection, []issues.Issue{
		{
			ID:         "issue-1",
			Raw:        "New raw",
...
func TestOverlayProjectionIssueMetadataEnablesStatusFilteringWithoutRelayout(t *testing.T) {
	...
	filtered := issueviews.SubsetProjectionByStatus(updated, issueviews.IssueStatusFilterClosed)
