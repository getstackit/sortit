...
// Tag names in the fixture taxonomy. Hoisted to constants so the many
// references in issueSpecs below stay typo-safe and consistent.
const (
	tagBilling       = "billing"
...
var tagSpecs = []tagSpec{
	{tagBilling, "money", 0.75, "Billing, invoices, charges, and refunds"},
	{tagPayments, "money", 0.80, "Payment processing and card transactions"},
	{tagAuth, "identity", 0.70, "Authentication and session handling"},
	{tagLogin, "identity", 0.75, "Login flows and credentials"},
	{tagExport, "documents", 0.70, "Exporting data and documents"},
	{tagPDF, "documents", 0.85, "PDF generation and rendering"},
	{tagSearch, "discovery", 0.65, "Search indexing and ranking"},
	{tagPerformance, "performance", 0.50, "Latency, throughput, and resource usage"},
	{tagMobile, "mobile", 0.55, "Mobile apps in general"},
	{tagIOS, "mobile", 0.80, "iOS-specific behavior"},
	{tagNotifications, "communications", 0.70, "Push and in-app notifications"},
	{tagEmail, "communications", 0.75, "Email delivery and templates"},
	{tagDatabase, "data", 0.60, "Database queries and storage"},
	{tagMigration, "data", 0.80, "Schema migrations"},
	{tagUI, "general", 0.30, "General user interface"},
	{tagBackend, "general", 0.25, "General backend/server work"},
}
...
var querySpecs = []querySpec{
	...
	{id: "q-export-email", raw: "scheduled export email has corrupted attachment", noise: 0.35,
		tags: []TagScore{{tagExport, 0.8}, {tagEmail, 0.6}}},
}
