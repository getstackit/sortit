---
name: sortit-memory
description: "Create, inspect, or review durable Sortit memories. Use when a coding, review, planning, or debugging session produces knowledge that should outlive an issue or chat: decisions, lessons, constraints, patterns, references, or \"future agents should know\" context. Trigger phrases include \"save this as a memory\", \"remember that we decided...\", \"record this lesson\", \"the constraint is...\", \"future agents should know...\", \"use this pattern\", \"review the memory proposals\", and \"list active memories\"."
---
...
uncertain speculation. Use `$sortit-progress` for work done against an issue.
...
- `concept` - the canonical profile of a single noun (a subsystem, component, or
  domain concept). A concept's subject *is* a tag: pass `--kind concept
  --subject-tag <tag>`. It is bound 1:1 to that tag and supersedes any prior
  concept for the same tag.
